...
public class RocketMessageProducer {
     ...
     * @param text
     */
    public void send(String topic, String tag, String text) {
        start();
        try {
            topic = profile + topic;
     ...
     * @param text
     */
    public void sendAsync(String topic, String tag, String text) {
        start();
        try {
            topic = profile + topic;
            byte[] content = text.getBytes(RemotingHelper.DEFAULT_CHARSET);
     ...
     * @param text
     */
    public void sendOneWay(String topic, String tag, String text) {
        start();
        try {
            topic = profile + topic;
            byte[] content = text.getBytes(RemotingHelper.DEFAULT_CHARSET);
     ...
     * @param level
     */
    public void sendDelay(String topic, String tag, String text, int level) {
        start();
        try {
            topic = profile + topic;
            byte[] content = text.getBytes(RemotingHelper.DEFAULT_CHARSET);
